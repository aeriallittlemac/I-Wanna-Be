...
//setPlayerFace();
if instance_exists(obj_gambino_couch){
	depth = obj_gambino_couch.depth-1;
}
else{
...
!global.in_dialogue && !global.timed_dialogue && entityActivateScript != -1 && entityActivateArg != -1  && !instance_exists(obj_rhythm_game_arrows)
