...
if global.day == 2 && global.game_time = "3:30 pm"{
	...
	if global.storylines.Grace.truth_or_dare_confession{
		if !global.storylines.Sewing_Club.Day_Three.talked_to.brooklyn{
			if !global.storylines.Grace.deny_rumor{
				...
				scr_text("That's it?");
				scr_text("What, do you want me to delete the photos?", spr_brooklyn_portrait_default, 0);
				scr_text("It's too late. What's on the internet is pretty much permanent.", spr_brooklyn_portrait_default, 0);
			...
			scr_text("I pity the fool...", spr_brooklyn_portrait_default, 0);
		}
	
	}
	else{
		if !global.storylines.Sewing_Club.Day_Three.talked_to.brooklyn{
			scr_text("Oh, kid. What do you want?", spr_brooklyn_portrait_default, 0);
			scr_text("Hand her the letter?");
				...
				function branches(branch){
					...
					switch(branch){
						...
						break;
						case "no":
							scr_text("And what are you looking at me for?", spr_brooklyn_portrait_default, 0);
						break;
					}
			...
			scr_text("What?", spr_brooklyn_portrait_default, 0);
		}
	...
	scr_text("Test dialogue", spr_brooklyn_portrait_default, 0);
}