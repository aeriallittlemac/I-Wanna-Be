...
function ask_about_club() {
	obj_scribble.textbox_unnamed("You ask what's with the sewing club.",
...
function any_interests() {
	obj_scribble.textbox_unnamed("You ask her if she has any interests",
	,,obj_textbox_mock_pink, obj_bounds_mock_pink
	);
	...
	[/page][instance_create_object,cutscene_dating_shatter]WBU? Preferably something that isn't with the lexicon of a fourth grader.
	",
...
function sniff() {
	obj_scribble.textbox_unnamed(@"You breathe in deeply,
	...
	obj_scribble.textbox(
	@"[instance_create_object,cutscene_dating_shatter]...
	...
	obj_scribble.textbox(
	"You've got something that isn't a complete waste of time?",
	"Brooklyn",spr_brooklyn_portrait_default,,,obj_textbox_mock_pink,obj_namebox_mock_pink,obj_bounds_mock_pink,obj_name_mock_pink,,,[
