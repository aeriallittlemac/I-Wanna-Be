...
draw_sprite_ext(spr_rhythm_block_snare, -1, x*minimap_scale, 0, minimap_scale, minimap_scale, 0, c_white, 1 );
...
if SNARE_DRUM && obj_rhythm_game.rhythm_line_x_pos + 135 >= block_left_border && obj_rhythm_game.rhythm_line_x_pos + 135 <= block_right_border{
	audio_play_sound(sfx_clap, 1, false);
