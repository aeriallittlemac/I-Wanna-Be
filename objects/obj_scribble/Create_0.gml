...
function textbox(text, name, portrait_sprite, textbox=TEXTBOX_DEFAULT, namebox=NAMEBOX_DEFAULT, bounds=BOUNDS_DEFAULT, portrait=PORTRAIT_DEFAULT, typist=TYPIST_DEFAULT) {
