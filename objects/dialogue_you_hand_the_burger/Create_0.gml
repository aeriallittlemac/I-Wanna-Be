...
scr_text("All...for me?", spr_grace_portrait_default, 0);
...
function branches(branch){
	...
	switch(branch){
		...
		case "tease":
			...
			scr_text("And that f-feels kind of wrong, somehow...", spr_grace_portrait_default, 0);
			
			scr_text("Anyways, are you sure you don't want a piece?", spr_grace_portrait_default, 0);
			
			scr_text("You tell her you're good.");
			
			scr_text("Alright, then...", spr_grace_portrait_default, 0);
