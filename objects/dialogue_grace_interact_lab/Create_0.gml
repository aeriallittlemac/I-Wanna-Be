...
if global.storylines.Grace.truth_or_dare_confession{
	scr_text("Hey, you.", spr_grace_portrait_default, 0);
	scr_text("What the hell was that yesterday?", spr_grace_portrait_default, 0);
	scr_text("Why does everyone think that you and me are an item?", spr_grace_portrait_default, 0);
	scr_text("Is this some kind of joke?", spr_grace_portrait_default, 0);
}
else{
