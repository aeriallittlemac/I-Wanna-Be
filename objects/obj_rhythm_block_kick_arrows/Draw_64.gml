if instance_exists(obj_rhythm_game_new){
	//draw_sprite_ext(kick_sprite, on_beat, x*minimap_scale, y*minimap_scale, minimap_scale*((obj_rhythm_game_new.right_border - obj_rhythm_game_new.left_border)/224), minimap_scale*((obj_rhythm_game_new.right_border - obj_rhythm_game_new.left_border)/224), 0, c_white, 1 );
