...
if global.day == 2 && global.game_time == "3:30 pm"{
	...
	if global.storylines.Grace.truth_or_dare_confession{
			...
			if global.storylines.Grace.deny_rumor{
				if !global.storylines.Sewing_Club.Day_Three.mei_resolves_to_talk{
					scr_text("...", spr_mei_portrait_default, 0);
					scr_text("She looks like she wants to say something to you...");
					scr_text("But whenever you look her way, she averts her gaze.");
				}
				else{
					scr_text("Um...", spr_mei_portrait_default, 0);
				...
				if !global.storylines.Sewing_Club.Day_Three.talked_to.mei{
					...
					scr_text("is if a boy rejected her. Or if her eating habits came out.", spr_brooklyn_portrait_default, 0);
