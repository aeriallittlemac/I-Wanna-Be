...
scr_text("But hey, sometimes little jokes turn into criminal records, you know.", spr_brooklyn_portrait_default, 0);
scr_text("It happens.", spr_brooklyn_portrait_default, 0);