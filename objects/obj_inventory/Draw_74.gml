	...
	draw_sprite_ext(spr_inventory_persona, inventory_anim_frame, 0, 0, minimap_scale, minimap_scale, 0, c_white, 1 );
	if !in_animation && array_length(inventory)>0 && global.in_inventory{
