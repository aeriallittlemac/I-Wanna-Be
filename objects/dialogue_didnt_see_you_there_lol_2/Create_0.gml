...
scr_text("Don't you know that I could make your life at school a living hell?", spr_grace_portrait_default, 0);
...
function branches(branch){
	...
	switch(branch){
		...
		case "apologize":
			...
			scr_text("*sigh", spr_grace_portrait_default, 0);
			scr_text("Another clown has come to the circus to play...", spr_grace_portrait_default, 0);
