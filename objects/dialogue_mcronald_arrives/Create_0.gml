...
obj_scribble.textbox(
	@"Gambino! McRonald has thought of a brilliant-
	[/page][scale,2]GAMBINO!
	[/page]NOOOOOOOOOOOOO![/]
	[/page]Oh, WHO could have DONE this-
	[/page][jitter]this TRAVESTY?![/jitter]
	[/page]Oh, WHO could have DONE this-
...
obj_scribble.textbox(
	@"That WENCH! 
	[/page]This is exactly what I speak of, Drake.
	[/page]We need to be vigilant!
...
obj_scribble.textbox(
	...
	[/page]He fed lies to Brooklyn about Gambino, spread rumors about their relationship,
...
obj_scribble.textbox(
	@"Agreed, Drake.
	[/page]But Bobby looks to be too popular for that.
	[/page]If we move too quickly, and with no evidence, the other students will be upset.
...
obj_scribble.textbox(
	...
	[/page]His ambitions are some of McRonald's very own.
	[/page]McRonald had tried on multiple occasions to convince Gambino of that witch and Bobby's evil intentions,
...
obj_scribble.textbox(
	@"*sniff
	[/page]McRonald wishes he could've done more, Drake. That is why-
	[/page]It only feels right to McRonald... That he carries on Gambino's legacy in the election.
...
obj_scribble.textbox(
	@"Well then, why don't you give the key to McRonald?
