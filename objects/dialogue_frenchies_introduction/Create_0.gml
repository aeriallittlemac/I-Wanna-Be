...
obj_scribble.textbox_unnamed(
	@"You tell him that your name is Bobby.
	", 
);

obj_scribble.textbox(
	@"Oh, okay. Thanks.
	[/page]The guys on this floor seem super scary, especially that Wei guy...
	[/page]But you seem a bit easier to talk to.
	[/page]I hope we get along!
	", 
	"Frenchie", spr_frenchie_portrait_twiddling_thumbs
);
//obj_scribble.textbox_unnamed(
